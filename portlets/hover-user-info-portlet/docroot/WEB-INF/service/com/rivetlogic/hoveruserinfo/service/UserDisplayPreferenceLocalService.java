...
/**
 * Provides the local service interface for UserDisplayPreference. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author juancarrillo
 * @see UserDisplayPreferenceLocalServiceUtil
...
public interface UserDisplayPreferenceLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserDisplayPreferenceLocalServiceUtil} to access the user display preference local service. Add custom service methods to {@link com.rivetlogic.hoveruserinfo.service.impl.UserDisplayPreferenceLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
